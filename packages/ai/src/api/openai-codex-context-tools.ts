// Native schemas from Codex ext/history-notes/src/tools.rs. Keep encrypted annotations intact.
import type { Tool } from "openai/resources/responses/responses.js";

export const openAICodexContextTools: Tool[] = [
	{
		type: "namespace",
		name: "history",
		description:
				...
				parameters: {
					...
					properties: {
						...
						item_id: {
							type: "string",
							description:
								"The short item ID is the suffix shown in the target item's trailing `[id: ...]` marker, printed after that item's content.",
						},
						offset_chars: {
							type: "integer",
							minimum: 0,
				...
				parameters: {
					...
					properties: {
						...
						start_line: {
							...
							description:
								"First line to return, inclusive and 1-based. Negative values count backward from the final line.",
						},
						stop_line: {
							anyOf: [
								{
							...
							description:
								"Last line to return, inclusive and 1-based. Negative values count backward from the final line.",
						},
					},
					required: ["path"],
				},
