...
async function loadModelsDevData(): Promise<Model<any>[]> {
	try {
		...
		// Process Cloudflare AI Gateway models. The gateway proxies Workers AI through its
		// OpenAI-compatible /compat endpoint, but models.dev may omit or intermittently drop
		// those `workers-ai/*` entries from the AI Gateway catalog. Mirror the Workers AI
		// catalog under the documented prefix so the gateway catalog remains stable.
